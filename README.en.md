...
Documentation in this repo is maintained bilingually: Chinese is the primary
...
Verification matrix, rollback table, add-worker recipe:
[docs/DEPLOY.en.md](docs/DEPLOY.en.md).
Design and protocol details: [docs/ARCHITECTURE.en.md](docs/ARCHITECTURE.en.md).
Known upstream issues and workarounds:
[docs/KNOWN_ISSUES.en.md](docs/KNOWN_ISSUES.en.md).
